...
if($_POST['search_text'] != '' || ($_POST['date11'] != '' && $_POST['date22'] != '')){
        ...
        $url_data = 'https://hondaproject.herokuapp.com/search_test_rides/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP&page='.$page;
        $options_data = array(
          'http' => array(
            'header'  => $header,
            'method'  => 'GET',
        ...
        $url_data = 'https://hondaproject.herokuapp.com/get_all_test_rides/?access_token=PQtL7kGM2fVN14XMnn9kZnVvC3uuKP&page='.$page;
        $options_data = array(
          'http' => array(
            'header'  => "Content-type: application/x-www-form-urlencoded\r\n",
            'method'  => 'GET',
